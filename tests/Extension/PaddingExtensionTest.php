 ...
 * @internal
 */
#[CoversClass(PaddingExtension::class)]
final class PaddingExtensionTest extends TestCase
{
    ...
    public function testSetPaddingLengthChaining(): void
    {
        ...
        // Verify the padding length was set correctly
        $this->assertSame(100, $extension->getPaddingLength());
    }
