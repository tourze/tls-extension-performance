 ...
 * @internal
 */
#[CoversClass(MaxFragmentLengthExtension::class)]
final class MaxFragmentLengthExtensionTest extends TestCase
{
    ...
    public function testSetLengthChaining(): void
    {
        ...
        // Verify the length was set correctly
        $this->assertSame(MaxFragmentLengthExtension::LENGTH_1024, $extension->getLength());
    }
