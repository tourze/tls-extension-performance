...
/**
 * CompressedCertificateExtension 测试类
 */
class CompressedCertificateExtensionTest extends TestCase
{
    ...
    {
        $extension = new CompressedCertificateExtension();
        $result = $extension->setAlgorithms([CertificateCompressionAlgorithm::ZLIB]);
