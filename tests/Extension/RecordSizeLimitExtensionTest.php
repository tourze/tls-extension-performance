 ...
 * @internal
 */
#[CoversClass(RecordSizeLimitExtension::class)]
final class RecordSizeLimitExtensionTest extends TestCase
{
    ...
    public function testSetRecordSizeLimitChaining(): void
    {
        ...
        // Verify the record size limit was set correctly
        $this->assertSame(1024, $extension->getRecordSizeLimit());
    }
